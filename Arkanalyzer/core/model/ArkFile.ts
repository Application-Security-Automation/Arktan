...
export class ArkFile {
    ...
    public addArkClass(arkClass: ArkClass) {
        if(this.classes.has(arkClass.getName())) {
            let methods = arkClass.getMethods();
            methods.forEach(m => {
                this.classes.get(arkClass.getName())?.addMethod(m);
            })
        }
        else
            this.classes.set(arkClass.getName(), arkClass);
        if(arkClass.getName() === "String")
            this.scene.NativeClass.set("string",this.classes.get(arkClass.getName())!);
        if(arkClass.getName() === "Map")
            this.scene.NativeClass.set("map",this.classes.get(arkClass.getName())!);
        if(arkClass.getName() === "Set")
            this.scene.NativeClass.set("set",this.classes.get(arkClass.getName())!);
        if(arkClass.getName() === "Array")
            this.scene.NativeClass.set("array",this.classes.get(arkClass.getName())!);
        if(arkClass.getName() === "JSON")
            this.scene.NativeClass.set("json",this.classes.get(arkClass.getName())!);
    }
